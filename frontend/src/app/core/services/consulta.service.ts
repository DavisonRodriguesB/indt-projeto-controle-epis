...
export class ConsultaService {
  ...
  buscarEntregas(filtros: any): Observable<EntregaCompleta[]> {
    ...
    if (filtros.colaborador_id) params = params.set('colaborador_id', filtros.colaborador_id);
    if (filtros.dataInicio)     params = params.set('data_inicio', filtros.dataInicio);
    if (filtros.dataFim)        params = params.set('data_fim', filtros.dataFim);
    ...
    if (filtros.ca)             params = params.set('ca', filtros.ca);
